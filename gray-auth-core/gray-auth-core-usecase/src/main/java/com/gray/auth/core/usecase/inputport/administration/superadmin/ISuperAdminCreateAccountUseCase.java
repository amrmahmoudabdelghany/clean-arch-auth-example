...
public interface ISuperAdminCreateAccountUseCase extends Function<ISuperAdminCreateAccountUseCase.CreateAccountRequest, ISuperAdminCreateAccountUseCase.CreateAccountResponse> {
    ...
    static ISuperAdminCreateAccountUseCase newInstance(ITokenProcessor tokenProcessor, IAccountRepo repo, IPasswordEncoder passwordEncoder, IAuthPersistenceGateway gateway) {
        return new DefaultSuperAdminCreateAccount(repo, passwordEncoder, tokenProcessor, gateway);
    }

    @AllArgsConstructor
    class DefaultSuperAdminCreateAccount implements ISuperAdminCreateAccountUseCase {
        ...
        public CreateAccountResponse apply(CreateAccountRequest request) {
            ...
            if (newAccount.isSuperAdmin()) {
                throw new IllegalInputException("SuperAdmin can not create SuperAdmin accounts.");
            }
            ...
            return new CreateAccountResponse("SuperAdmin Create Account Successfully");
        }
    }
